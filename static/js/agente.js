...
app.controller('myCtrl', function($scope,$http,$filter) {
   ...
   $(".preload").css("display", "block");
    ...
    $scope._detalleagente=function(agente){


        $http.get("/detalleagente/"+agente).success(function(response) { 


        console.log('detalleagente,',response)

        $scope.detalleagente = response[0];
    ...
    $scope._jerarquia=function(agente){


        $http.get("/jerarquia/"+agente).success(function(response) { 

        $scope.jerarquia = response;

         
        $scope.detalleagente.agente_asigna = response
    ...
    $scope.traeagente=function(p){


        $scope.detalleagente=p

        $scope.search=''

        delete $scope.jerarquia
    }
